...
[_QW] = LAYOUT(
  ...
  CTL_T(KC_ESC), KC_LALT, KC_LGUI, MO(_FN), KC_BSPC, MO(_VI), KC_ENT,  KC_SPC,  KC_TAB,  XXXXXXX, KC_QUOT,  CTL_T(KC_ESC) ),
[_VI] = LAYOUT(
  ...
  _______,       _______, _______, RESET,   KC_DEL,  _______, _______, _______, _______, XXXXXXX, KC_QUOT,  _______ ),
[_FN] = LAYOUT(
